...
<head>
    ...
    <link rel="icon" type="image/png" href="/apps/assets/img/favicon.png" />
...
<div id="app" class="wrapper">
    <div class="sidebar" data-active-color="rose" data-background-color="black" data-image="/apps/assets/img/sidebar-1.jpg">
        <!--
...
-->
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img src="/apps/assets/img/faces/avatar.jpg" />
                </div>
                <div class="info">
                                        ...
                                        <div class="table-responsive table-sales">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/US.png">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/DE.png">
                                                        </div>
                                                    </td>
                                                    <td>Germany</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/AU.png">
                                                        </div>
                                                    </td>
                                                    <td>Australia</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/GB.png">
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/RO.png">
                                                        </div>
                                                    </td>
                                                    <td>Romania</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/apps/assets/img/flags/BR.png">
                                                        </div>
                                                    </td>
                                                    <td>Brasil</td>
                                                    <td class="text-right">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="/apps/assets/img/card-2.jpeg">
                                </a>
                            </div>
                            <div class="card-content">
                                <div class="card-actions">
                    ...
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="/apps/assets/img/card-3.jpeg">
                                </a>
                            </div>
                            <div class="card-content">
                                <div class="card-actions">
                    ...
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="/apps/assets/img/card-1.jpeg">
                                </a>
                            </div>
                            <div class="card-content">
                                <div class="card-actions">
